...
* Date: 29-11-2021
* Description: Actions and functions implementation of the coworking center
*/
#include <stdio.h>
#include <stdlib.h>
#include <string.h>
...
/*************** PR1 EX5A *****************/
	...
	coworkingCenterTableInit(result); 
	for(i = ZERO;i < selectedCoworkingCenters.nCoworkingCenters;i++){
		if(strcmp(coworker.birthCity,selectedCoworkingCenters.table[i].city) != ZERO){
